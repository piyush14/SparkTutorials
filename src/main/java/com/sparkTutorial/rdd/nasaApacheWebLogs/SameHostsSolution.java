...
public class SameHostsSolution {
	...
	public static void main(String[] args) throws Exception {
		...
		for (String line : cleanedHostIntersection.collect())
			System.out.println(line);
		
		cleanedHostIntersection.saveAsTextFile("file:///E:/Udemy SparkTutorial/sparkTutorial/out/nasa_logs_same_hosts");
	}
}
